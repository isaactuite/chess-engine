...
extern int bot_pawn_logic(int x, int y, int color, int mode, int *castling);
extern int bot_knight_logic(int x, int y, int color, int mode, int *castling);
extern int bot_rook_logic(int x, int y, int color, int mode,int *castling);
extern int bot_bishop_logic(int x, int y, int color, int mode, int *castling);
extern int bot_queen_logic(int x, int y, int color, int mode, int *castling);
extern int bot_king_logic(int x, int y, int color, int mode, int *castling);
...
extern int bot_is_checkmate(int *castling);
